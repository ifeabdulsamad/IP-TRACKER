...
export default function App() {
  ...
  >
        ...
        {/* Result */}
        {result && (
          <div className="mt-6  p-4 rounded-lg text-gray-200 md:flex justify-between mx-auto">
            <p className="md:w-32 rounded-tl-lg rounded-bl-lg border md:border-t-amber-50 my-5 w-full sm:my-3  md:mx-2 px-2 py-2.5 bg-[#04001d]">
              <b>IP: <br /></b> {result.ip}
            </p>
            <p className="md:w-32 rounded-tl-lg rounded-bl-lg border md:border-t-amber-50 my-5 w-full sm:my-3  md:mx-2 px-2 py-2.5 bg-[#04001d]">
            ...
            <p className="md:w-32 rounded-tl-lg rounded-bl-lg border border-t-amber-50 my-5 w-full sm:w-full sm:my-3  md:mx-2 px-2 py-2.5 bg-[#04001d]">
